...
enum R {
    ...
    enum drawable {
        ...
        static var heartCircle: String { "heartCircle" }
        static var home: String { "home" }
        static var info: String { "info" }
        static var jcb: String { "jcb" }
        ...
        static var masterCard: String { "masterCard" }
        static var mir: String { "mir" }
        ...
        static var splashBg: String { "splashBg" }
        static var trash: String { "trash" }
        static var unionPay: String { "unionPay" }
        static var visa: String { "visa" }
