//
// SetListPaymentsForTerminalRequestPaymentsInner.swift
//
...
public struct SetListPaymentsForTerminalRequestPaymentsInner: Codable, Hashable {
    ...
    public init(paymentId: Int64, forDiscount: Bool? = nil, forCashback: Bool? = nil) {
