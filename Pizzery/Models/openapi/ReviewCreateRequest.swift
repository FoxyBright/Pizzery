...
public struct ReviewCreateRequest: Codable, Hashable {
    ...
    public init(id: Int64? = nil, clientId: Int64, outletId: Int64? = nil, partnerId: Int64? = nil, review: String, createdAt: Int64? = nil, rating: Int, visible: Bool) {
        self.id = id
...
extension ReviewCreateRequest: Identifiable {}
