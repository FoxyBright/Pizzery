//
// MenuItemListRequestFilterInner.swift
//
...
public struct MenuItemListRequestFilterInner: Codable, Hashable {

    public enum FilterParameter: String, Codable, CaseIterable {
        case partnerId = "partner_id"
        case visible = "visible"
    }
    /** Параметр, по которому осуществляется фильтрация.   partner_id - фильтрация по партнерам value_type: int64, value_group: single, repeated;   visible - фильтрация по видимым блюдам  */
